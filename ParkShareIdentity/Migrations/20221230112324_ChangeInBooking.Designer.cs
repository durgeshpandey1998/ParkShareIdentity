...
namespace ParkShareIdentity.Migrations
{
    ...
    [Migration("20221230112324_ChangeInBooking")]
    partial class ChangeInBooking
    {
            ...
            modelBuilder.Entity("ParkShareIdentity.Areas.Identity.Data.AddBooking", b =>
                {
                    ...
                    b.HasOne("ParkShareIdentity.Areas.Identity.Data.TimeWiseData", "timewise")
                        .WithMany()
                        .HasForeignKey("TimeWiseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
