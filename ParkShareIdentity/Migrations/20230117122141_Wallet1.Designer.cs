...
namespace ParkShareIdentity.Migrations
{
    ...
    [Migration("20230117122141_Wallet1")]
            ...
            modelBuilder.Entity("ParkShareIdentity.Areas.Identity.Data.Transaction", b =>
                {
                    ...
                    b.Property<string>("OwnerWalletId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("OwnerWalletWalletId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RenterWalletId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("RenterWalletWalletId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OwnerWalletWalletId");

                    b.HasIndex("RenterWalletWalletId");
            ...
            modelBuilder.Entity("ParkShareIdentity.Areas.Identity.Data.Transaction", b =>
                {
                    b.HasOne("ParkShareIdentity.Areas.Identity.Data.Wallet", "OwnerWallet")
                        .WithMany()
                        .HasForeignKey("OwnerWalletWalletId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ParkShareIdentity.Areas.Identity.Data.Wallet", "RenterWallet")
                        .WithMany()
                        .HasForeignKey("RenterWalletWalletId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
